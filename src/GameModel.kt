object GameModel {
    ...
    val foundationPiles: Array<FoundationPile> = arrayOf(FoundationPile(clubs), FoundationPile(diamonds), FoundationPile(hearts),FoundationPile(spades))
    ...
    fun onFoundationTap(foundationIndex: Int) {
        ...
        if(foundationPile.cards.size > 0) {
            ...
            if(playCard(card)) {
                foundationPile.removerCard(card);
            }
        }
    }
